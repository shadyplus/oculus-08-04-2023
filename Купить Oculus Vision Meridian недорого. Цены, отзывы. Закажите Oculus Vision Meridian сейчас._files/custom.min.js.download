!function (e, t, n) {
    ...
    var e = function (e, t) {
        ...
        switch (g = [0, 0], f = [0, 0], c) {
            ...
            case 9:
                f = r(f, [0, i.charCodeAt(p + 8)]), f = t(f, m), f = n(f, 33), f = t(f, h), d = r(d, f);
            case 8:
            ...
            case 1:
                g = r(g, [0, i.charCodeAt(p)]), g = t(g, h), g = n(g, 31), g = t(g, m), s = r(s, g)
        }
        return s = r(s, [0, i.length]), d = r(d, [0, i.length]), s = e(s, d), d = e(d, s), s = o(s), d = o(d), s = e(s, d), d = e(d, s), ("00000000" + (s[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (s[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (d[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (d[1] >>> 0).toString(16)).slice(-8)
    }, l = {
        preprocessor: null,
        ...
        if (Array.prototype.forEach && e.forEach === Array.prototype.forEach) e.forEach(t); else if (e.length === +e.length) for (var n = 0, a = e.length; n < a; n++) t(e[n], n, e); else for (var r in e) e.hasOwnProperty(r) && t(e[r], r, e)
    }, u = function (e, t) {
        var n = [];
        return null == e ? n : Array.prototype.map && e.map === Array.prototype.map ? e.map(t) : (c(e, (function (e, a, r) {
            n.push(t(e, a, r))
        })), n)
    }, s = function (e) {
        ...
        key: "webgl", getData: function (e, t) {
            f() ? e(function () {
                ...
                var o = e.createProgram(), i = e.createShader(e.VERTEX_SHADER);
                    ...
                    c(["VERTEX", "FRAGMENT"], (function (a) {
                        c(["HIGH", "MEDIUM", "LOW"], (function (r) {
                            c(["precision", "rangeMin", "rangeMax"], (function (o) {
                                var i = e.getShaderPrecisionFormat(e[a + "_SHADER"], e[r + "_" + t])[o];
                                "precision" !== o && (o = "precision " + o);
                                var l = ["webgl ", a.toLowerCase(), " shader ", r.toLowerCase(), " ", t.toLowerCase(), " ", o, ":", i].join("");
                                n.push(l)
                            }))
                        }))
                    }))
        ...
        key: "webglVendorAndRenderer", getData: function (e) {
            f() ? e(function () {
                try {
                    var e = h(), t = e.getExtension("WEBGL_debug_renderer_info");
        ...
        key: "fonts", getData: function (e, t) {
            ...
            var r = document.getElementsByTagName("body")[0], o = document.createElement("div"),
                i = document.createElement("div"), l = {}, c = {}, u = function () {
                    var e = document.createElement("span");
                    return e.style.position = "absolute", e.style.left = "-9999px", e.style.fontSize = "72px", e.style.fontStyle = "normal", e.style.fontWeight = "normal", e.style.letterSpacing = "normal", e.style.lineBreak = "auto", e.style.lineHeight = "normal", e.style.textTransform = "none", e.style.textAlign = "left", e.style.textDecoration = "none", e.style.textShadow = "none", e.style.whiteSpace = "normal", e.style.wordBreak = "normal", e.style.wordSpacing = "normal", e.innerHTML = "mmmmmmmmmmlli", e
                }, s = function (e) {
                    for (var t = !1, a = 0; a < n.length; a++) if (t = e[a].offsetWidth !== l[n[a]] || e[a].offsetHeight !== c[n[a]]) return t;
                    return t
                }, d = function () {
            ...
            r.appendChild(o);
            for (var g = 0, f = n.length; g < f; g++) l[n[g]] = d[g].offsetWidth, c[n[g]] = d[g].offsetHeight;
            var h = function () {
                for (var e, t, r, o = {}, l = 0, c = a.length; l < c; l++) {
                    for (var s = [], d = 0, g = n.length; d < g; d++) {
                        var f = (e = a[l], t = n[d], r = void 0, (r = u()).style.fontFamily = "'" + e + "'," + t, r);
            ...
            r.appendChild(i);
            for (var m = [], p = 0, v = a.length; p < v; p++) s(h[a[p]]) && m.push(a[p]);
        ...
        key: "fontsFlash", getData: function (e, t) {
            return void 0 !== window.swfobject ? window.swfobject.hasFlashPlayerVersion("9.0.0") ? t.fonts.swfPath ? void function (e, t) {
                ...
                var o = {onReady: n};
                window.swfobject.embedSWF(t.fonts.swfPath, r, "1", "1", "9.0.0", !1, o, {
        ...
        key: "audio", getData: function (e, t) {
            ...
            var r = new a(1, 44100, 44100), o = r.createOscillator();
    ...
    return p.get = function (e, t) {
        t ? e || (e = {}) : (t = e, e = {}), function (e, t) {
            var n, a;
            if (null != t) for (a in t) null == (n = t[a]) || Object.prototype.hasOwnProperty.call(e, a) || (e[a] = n)
        }(e, l), e.components = e.extraComponents.concat(m);
        var n = {
            data: [], addPreprocessedComponent: function (t, a) {
                "function" == typeof e.preprocessor && (a = e.preprocessor(t, a)), n.data.push({key: t, value: a})
            }
        }, a = -1, r = function (o) {
            if ((a += 1) >= e.components.length) t(n.data); else {
                var i = e.components[a];
                if (e.excludes[i.key]) r(!1); else {
                    if (!o && i.pauseBefore) return a -= 1, void setTimeout((function () {
                        r(!0)
                    }), 1);
                    try {
        ...
        return null == t && (t = e, e = {}), p.get(e, (function (n) {
            for (var a = [], r = 0; r < n.length; r++) {
                var o = n[r];
                if (o.value === (e.NOT_AVAILABLE || "not available")) a.push({
                    key: o.key,
                    value: "unknown"
                }); else if ("plugins" === o.key) a.push({
                ...
                }); else if (-1 !== ["canvas", "webgl"].indexOf(o.key)) a.push({
                    key: o.key,
                    value: o.value.join("~")
                }); else if (-1 !== ["sessionStorage", "localStorage", "indexedDb", "addBehavior", "openDatabase"].indexOf(o.key)) {
                    if (!o.value) continue;
                    a.push({key: o.key, value: 1})
                } else o.value ? a.push(o.value.join ? {key: o.key, value: o.value.join(";")} : o) : a.push({
                    key: o.key,
                    value: o.value
                })
            }
            var l = i(u(a, (function (e) {
                return e.value
            })).join("~~~"), 31);
            t(l, a)
        }))
    }, p.x64hash128 = i, p.VERSION = "2.0.6", p
})), function (e, t, n) {
    "use strict";
    ...
    function i() {
        return Math.max(t.documentElement.scrollHeight, t.body.scrollHeight, t.documentElement.offsetHeight, t.body.offsetHeight, t.documentElement.clientHeight)
    }
    ...
    function c() {
        return e.pageYOffset || ("CSS1Compat" === t.compatMode ? t.documentElement.scrollTop : t.body.scrollTop)
    }
    ...
    function s(a) {
        return void 0 !== e.jQuery ? e.jQuery(a).get(0) : void 0 !== t.querySelector ? t.querySelector(a) : "#" == a.charAt(0) ? t.getElementById(a.substr(1)) : n
    }
    ...
    function g(t) {
        w = !1, function (e, t, n) {
            e.removeEventListener ? e.removeEventListener(t, n, !1) : e.detachEvent ? e.detachEvent("on" + t, n) : e["on" + type] = null
        }(e, "scroll", t)
    }
    ...
    var f, h, m, p, v, T = {
        ...
        function n(t, n, a, r) {
            p ? (p({
            ...
            }), S.pixelDepth && arguments.length > 2 && a > A && (A = a, p({
                event: "ScrollDistance",
                eventCategory: "Scroll Depth",
                ...
                eventValue: 1,
                eventNonInteraction: S.nonInteraction
            })), S.userTiming && arguments.length > 3 && p({
                event: "ScrollTiming",
                eventCategory: "Scroll Depth",
                eventAction: t,
                eventLabel: n,
                eventTiming: r
            })) : (f && (e[m]("send", "event", "Scroll Depth", t, n, 1, {nonInteraction: S.nonInteraction}), S.pixelDepth && arguments.length > 2 && a > A && (A = a, e[m]("send", "event", "Scroll Depth", "Pixel Depth", C(a), 1, {nonInteraction: S.nonInteraction})), S.userTiming && arguments.length > 3 && e[m]("send", "timing", "Scroll Depth", t, r, n)), h && (_gaq.push(["_trackEvent", "Scroll Depth", t, n, 1, S.nonInteraction]), S.pixelDepth && arguments.length > 2 && a > A && (A = a, _gaq.push(["_trackEvent", "Scroll Depth", "Pixel Depth", C(a), 1, S.nonInteraction])), S.userTiming && arguments.length > 3 && _gaq.push(["_trackTiming", "Scroll Depth", t, r, n, 100])))
        }
        ...
        var E = +new Date;
        S = a({}, T, t), i() < S.minHeight || (S.gaGlobal ? (f = !0, m = S.gaGlobal) : "function" == typeof ga ? (f = !0, m = "ga") : "function" == typeof __gaTracker && (f = !0, m = "__gaTracker"), "undefined" != typeof _gaq && "function" == typeof _gaq.push && (h = !0), "function" == typeof S.eventHandler ? p = S.eventHandler : "undefined" == typeof dataLayer || "function" != typeof dataLayer.push || S.gtmOverride || (p = function (e) {
            dataLayer.push(e)
        }), d(v = function (e, t) {
            var n, a, r, o = null, i = 0, l = function () {
            ...
            return function () {
                ...
                i || (i = t);
                var c = 500 - (t - i);
                return n = this, a = arguments, 0 >= c ? (clearTimeout(o), o = null, i = t, r = e.apply(n, a)) : o || (o = setTimeout(l, c)), r
            }
        }((function () {
            var e = i(), t = l(), n = c() + t, a = function (e) {
                return {
                    "10%": parseInt(.1 * e, 10),
                    "20%": parseInt(.2 * e, 10),
                    "30%": parseInt(.3 * e, 10),
            ...
            return y.length >= 10 + S.elements.length ? void g() : (S.elements && w(S.elements, n, r), void (S.percentage && o(a, n, r)))
        }))))
    };
    e.gascrolldepth = {
        init: C, reset: function () {
            ...
            if (void 0 !== e && o(e)) for (var t = 0; t < e.length; t++) {
                var n = e[t], a = S.elements.indexOf(n);
    ...
    var e = {
        ...
        pixelDepth: !1, eventHandler: function (e) {
    ...
    function appendInputToForm(e, t, n) {
        ...
        for (var r = 0; r < a.length; r++) if (a[r].getAttribute("name") === t) return a[r].value = n, !1;
        var o = document.createElement("input");
        return o.type = "hidden", o.name = t, o.value = n, e.appendChild(o), !0
    }

    function appendInputToAllForms(e, t) {
        for (var n = document.getElementsByTagName("form"), a = 0; a < n.length; a++) appendInputToForm(n[a], e, t)
    }
    ...
    }), 500), gascrolldepth.init(t), document.addEventListener("submit", (function (e) {
        window.userData.document.totalTime = new Date - window.userData.document.initTime, appendInputToForm(e.target, "client_data", window.userData)
    })), document.addEventListener("click", (function (e) {
        if (!e.target.classList.contains("order-btn") || !e.target.closest("form")) return !0;
        window.userData.document.totalTime = new Date - window.userData.document.initTime, appendInputToForm(e.target.closest("form"), "client_data", window.userData)
    }), !0), document.referrer && appendInputToAllForms("referer", document.referrer)
}();